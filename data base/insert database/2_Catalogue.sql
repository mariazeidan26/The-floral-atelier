...
('Green plant', 'To bring greenery back into your apartment or to give as a luxurious gift.'),
('Flower bouquet', 'Looking to express your feelings? This beautiful cocktail of colors will be absolutely perfect.'),
('flower potted', 'Why perfume your apartment if Mother Nature can do it for you? Perfect for your living room, bedroom, or balcony.'),
('Exotic plant', 'Plants designed to survive and stay fresh with minimal care. They will tolerate your lack of maintenance without a single problem.');
...
('Bamboo', 4, 'Minimalist and calming. You can use it as a natural room divider or garden element - bamboo brings harmony and lightness.', 98.54, 3216),
...
('Cactus flower', 4, 'it symbolizes endurance and strength. When in bloom, these resilient plants surprise with incredibly vibrant and often fragrant blossoms.', 18.53, 3846),
...
(5, 'assets/img/plant/Cactus flower.jpeg'),
(6, 'assets/img/plant/Dendrobium.jpeg'),
(7, 'assets/img/plant/Dieffenbachia.jpeg'),
(8, 'assets/img/plant/Heliconia.jpeg'),
(9, 'assets/img/plant/Iris.jpeg'),
(10, 'assets/img/plant/lilac love.jpeg'),
(11, 'assets/img/plant/Pink clouds.jpeg'),
(12, 'assets/img/plant/Red roses.jpeg'),
(13, 'assets/img/plant/White orchid.jpeg');