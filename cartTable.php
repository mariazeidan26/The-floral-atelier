                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    if ($result2->num_rows > 0) {
                                                        ...
                                                        ?>
<tr>
                                                <th scope="row"><img src="<?php echo $product['img']; ?>" alt="product-img" title="product-img" class="avatar-lg rounded"></th>
                                                <td>
                                                    <h5 class="font-size-16 text-truncate"><a href="#" class="text-dark"> <?php echo $product['nom']; ?></a></h5>
                                                    ...
                                                    <p class="text-muted mb-0 mt-1">$<?php echo $product['ID_Categorie'] == 2 ? $product['prix_unitaire'] : $product['prix']; ?> * <?php echo $row['quantite']; ?></p>
                                                </td>
                                                <td>$<?php echo ($product['ID_Categorie'] == 2 ? $product['prix_unitaire'] : $product['prix']) * $row['quantite']; ?></td>
